...
const FriendRequestToast = ({ userData, message }) => {
    console.log(userData)
    return (
        <div id="toast-notification" className="w-full max-w-xs p-4 text-gray-900 bg-white rounded-lg shadow  dark:text-gray-300" role="alert">
            ...
            <div className="flex items-center">
                ...
                <div className="ms-3 text-sm font-normal">
                    <div className="text-sm font-semibold text-gray-900 dark:text-white">{userData?.firstName} {userData?.lastName}</div>
